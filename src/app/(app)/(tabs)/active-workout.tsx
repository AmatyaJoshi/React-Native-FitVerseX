            ...
            <View className='flex-1 bg-white'>
                ...
                {workoutExercises.length === 0 && (
                    <View className='bg-gray-50 rounded-2xl p-8 items-center mx-6'>
                        ...
                        <Text className='text-center text-gray-600 mt-4 text-lg font-medium'>
                            No exercises yet.
                        </Text>
                            ...
                            <View key={exercise.id} className='mb-8'>
                                ...
                                <View className='bg-white rounded-2xl p-4 shadow-sm border border-gray-100 mb-3'>
                                    ...
                                    <TouchableOpacity
                                        ...
                                        className='bg-blue-100 border-2 border-dashed border-blue-300
                                    rounded-lg py-3 items-center mt-2'
                                    >
