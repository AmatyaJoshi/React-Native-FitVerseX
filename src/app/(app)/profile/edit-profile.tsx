    ...
    <SafeAreaView className={`flex flex-1 ${theme === 'dark' ? 'bg-black' : 'bg-gray-50'}`} edges={['top', 'left', 'right']}>
      <ScrollView className="flex-1">
        ...
        <View className="px-6 pt-6">
          <View className={`${theme === 'dark' ? 'bg-gray-900 border-gray-800' : 'bg-white border-gray-300'} rounded-2xl p-6 shadow-sm border mb-6`}>
            <Text className={`text-lg font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Profile Information</Text>
            
            {/* First Name */}
            <View className="mb-4">
              <Text className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-700'} mb-2`}>First Name</Text>
              <View className={`border ${theme === 'dark' ? 'border-gray-700 bg-gray-800' : 'border-gray-300 bg-gray-50'} rounded-lg px-4 py-3`}>
            ...
            {/* Last Name */}
            <View className="mb-4">
              <Text className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-700'} mb-2`}>Last Name</Text>
              <View className={`border ${theme === 'dark' ? 'border-gray-700 bg-gray-800' : 'border-gray-300 bg-gray-50'} rounded-lg px-4 py-3`}>
            ...
            {/* Email */}
            <View className="mb-4">
              <Text className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-700'} mb-2`}>Email Address</Text>
              <View className={`border ${theme === 'dark' ? 'border-gray-700 bg-gray-800' : 'border-gray-300 bg-gray-50'} rounded-lg px-4 py-3`}>
            ...
            {/* Phone */}
            <View>
              <Text className={`text-sm font-medium ${theme === 'dark' ? 'text-gray-400' : 'text-gray-700'} mb-2`}>Phone Number</Text>
              <View className={`border ${theme === 'dark' ? 'border-gray-700 bg-gray-800' : 'border-gray-300 bg-gray-50'} rounded-lg px-4 py-3`}>
                <Text className={theme === 'dark' ? 'text-gray-500' : 'text-gray-600'}>Not set</Text>
              </View>
            </View>
          </View>
